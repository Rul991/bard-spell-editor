...
const SidePanel = () => {
    ...
    const [recording] = useContext(IsRecordingContext)
    ...
    return <div className={styles.panel}>
        ...
        <Characteristics elements={
            [
...

                {
                    ...
                    value: recording ? 'активна': 'безактивна'
                },
        ...
        <div className="inputs">
            ...
            <Input songKey='script' title='Путь к Lua скрипту' type='string' />
            <Input songKey='duration' title='Длительность песни' type='number' />
        </div>
